...
const SceneButton = ({
  ...
  return (
    ...
    >
      ...
      {/* BOTTOM RIGHT: A/V Sync Offset Badge (Smaller & Monospaced) */}
      {isOnline && syncOffset !== null && syncOffset !== undefined && (
        <div
          className={`absolute bottom-2 right-2 backdrop-blur-md px-1 py-[2px] rounded-[3px] text-[9px] tracking-tight font-mono border shadow-md ${
            syncOffset === 0
...
export default function OBSPanel({
  ...
  const {
    ...
    autoSwitch,
    isStreaming,
    syncOffsets = {}, // Safe fallback default
  } = state;
